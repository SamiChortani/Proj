  ...
  return (
    <div className="w-full xl:h-screen relative text-white">
      ...
      <div className="xl:bg-main bg-dry flex-colo xl:bg-opacity-90 xl:absolute top-0 left-0 right-0 bottom-0">
        <div className="container px-3 mx-auto 2xl:px-32 xl:grid grid-cols-3 flex-colo py-10 lg:py-20 gap_8">
          ...
          <div className="col-span-2 md:grid grid-cols-5 gap-4 items-center">
            <div className="col-span-3 flex flex-col gap_10">
              {/* Title */}
              ...
              <div className="grid sm:grid-cols-5 grid-cols-3 gap-4 p-4 bg-main border border-gray-800 rounded-lg">
                {/* Share */}
                ...
                {/* watch button */}
                <div className="sm:col-span col-span-3 flex justify-end font-medium text-sm">
                  <Link to={`/watch/${movie?.title}`} className="bg-dry hover:bg-subMain transition border-2 border-subMain rounded-full flex-rows gap-4 w-full sm:py-3">
